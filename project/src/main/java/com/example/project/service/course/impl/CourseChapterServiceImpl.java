...
public class CourseChapterServiceImpl implements CourseChapterService {
    ...
    @Override
    @Transactional
    public CourseChapter createVideoChapter(String courseId, Long parentId, String title, Integer order, MultipartFile videoFile) {
        // 验证视频文件
    ...
    @Override
    @Transactional
    public CourseChapter createPdfChapter(String courseId, Long parentId, String title, Integer order, MultipartFile pdfFile) {
        // 验证PDF文件
    ...
    @Override
    @Transactional
    public CourseChapter createTextChapter(String courseId, Long parentId, String title, Integer order, String textContent) {
        CourseChapter chapter = new CourseChapter();
        chapter.setCourseId(courseId);
        chapter.setParentId(parentId);
        chapter.setChapterTitle(title);
