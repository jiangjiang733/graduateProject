...
public interface StudentCourseService {
     ...
     * 获取教师所有课程的学生列表
     */
    List<StudentCourse> getTeacherStudents(String teacherId, String courseId, String keyword, int pageNumber,
            int pageSize);
     ...
     * 获取学生加入的课程列表
     */
    List<Map<String, Object>> getStudentJoinedCourses(String studentId);
}