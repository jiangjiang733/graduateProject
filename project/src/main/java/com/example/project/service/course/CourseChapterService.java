...
public interface CourseChapterService {
     ...
     * 创建视频章节
     */
    CourseChapter createVideoChapter(String courseId, Long parentId, String title, Integer order,
     ...
     * 保存视频文件并返回 URL
     */
    String saveUploadedVideo(MultipartFile file);

    /**
     * 保存 PDF 文件并返回 URL
     */
    String saveUploadedPdf(MultipartFile file);
}
